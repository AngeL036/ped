...
from app.modules.empleado.schemes import CreateEmpleado, UpdateEmpleado, ResponseEmpleado, ResponseEmpleadoCreacion
...
@router.post("/", response_model=ResponseEmpleadoCreacion, status_code=201)
def crear_empleado(
